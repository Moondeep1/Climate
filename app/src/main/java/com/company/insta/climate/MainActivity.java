...
public class MainActivity extends AppCompatActivity {
    ...
    final String APP_ID = "375be70d1ae49285c1f053cc693a0a67";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeCityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, Change_city_layout.class);
    ...
    protected void onResume() {
        ...
        Log.d("Clima", "Getting weather conditions ");
    ...
    private void getWeatherForCurrentLocation() {
        ...
        locationListener = new LocationListener() {
            ...
            public void onProviderEnabled(String provider) {
                Log.d("Clima", "onProviderEnable callback received");
            }
...
int resources = getResources().getIdentifier(weatherDataModel.getmIconName(), "drawable", getPackageName());
mWeatherImage.setImageResource(resources);
}
